<div class="well"><span>Danh sách <?= $attribute_enable[$_GET['type']]['title'] ?> mở rộng (danh mục '<?=@$category['title']?>' - <?=$pagination->count_item?> <?= $attribute_enable[$_GET['type']]['title'] ?>)</span></div>
...
<table class="table table-striped table-bordered text-center">
	<tr>
		<td class="text-left" colspan="14">
			...
			<?php
				// $backUrl=preg_replace('/(&category_id=\d*)|(&type=[^&]*)/i', "", str_replace("?com=category-extend", "?com=category", getCurrentPageURL()));
